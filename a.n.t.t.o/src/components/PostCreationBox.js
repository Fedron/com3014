    ...
    <div className="my-4 card rounded-none lg:card-side bg-base-100 shadow">
        <form>
            <div className="my-4 ml-5 card rounded-none lg:card-side bg-base-100 shadow">
                <input type="text" id="ptitle" name="ptitle" placeholder="Post Title"></input><br></br>
            </div>
            <div className="my-4 ml-5 card rounded-none lg:card-side bg-base-100 shadow">
                <textarea rows="4" cols="73" placeholder="What are your thoughts on this?" id="pcontent" name="pcontent"></textarea><br></br>
            </div>
