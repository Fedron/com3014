                ...
                <div className="w-full mx-96 p-1">
                    <div className="max-w-md mx-auto w-full">   
                        <div className="relative">
                            <button type="submit" className="inline-flex items-center  text-base-100 absolute end-2.5 -bottom-10 bg-primary hover:bg-secondary focus:ring-4 focus:outline-none focus:ring-secondary font-medium rounded-lg text-base px-6 py-2">
