function EventDescCard({ imageUrl, title, desc, date, time, price, closingdate }) {
    return (
        <div className="bg-base-100 rounded-lg p-4 w-full ">
            ...
            <div className="flex space-x-1">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="#F1B53D" className="size-5">
            ...
            <div className="flex space-x-1">
                ...
                <h4 className="text-base font-semibold">
                    Closing date:&ensp;
                    <span className="text-base font-normal">{closingdate}</span>
                </h4>
            </div>
            <br></br>
