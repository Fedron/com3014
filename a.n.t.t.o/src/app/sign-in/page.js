...
export default function SignIn() {
    return (
        <div className="text-center mt-16 font-heading text-primary">
            ...
            <div className="inline-block w-80">
                ...
                <button className="btn btn-sm btn-primary text-base-100 w-full mt-4">SIGN IN</button>
                <div className="divider font-medium text-sm">OR</div>
                <button className="btn btn-sm btn-outline btn-primary font-medium w-full">
                    <Link href="/sign-in">NO ACCOUNT? SIGN UP HERE!</Link>
                </button>
            </div>
        </div>
    )
